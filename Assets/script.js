...
//   save.addEventListener("click", function (event) {
//     event.preventDefault();
//     const city = elements.searchBar.value;
//     getAPI(city);
//   });
...
// const cityFromDOM = cityList("./city.list.json");
...
//   for (const cityElement of cityFromDOM) {
//     // store name text and convert to lowercase
//     let city = cityElement.textContent.toLowerCase();
